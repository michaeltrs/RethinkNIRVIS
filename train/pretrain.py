...
def main(local_rank):
    ...
    # Margin softmax
    classifier = MarginSoftmaxClassifier(in_features=cfg.embedding_size, out_features=cfg.num_classes, s=64.0, m=cfg.margin).to(local_rank)
...
if __name__ == "__main__":
    ...
    cfg = importlib.import_module('train.configs.%s' % args.config).config
