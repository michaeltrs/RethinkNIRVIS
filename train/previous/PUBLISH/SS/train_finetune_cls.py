...
def main(local_rank):
    ...
    if cfg.vis_backbone_checkpoint not in ['', None]:
        ...
        weight = torch.load(cfg.vis_backbone_checkpoint, map_location='cuda:{}'.format(cfg.local_rank))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', type=str, default='config_iresnet18_commonembed', help='config file name')
    ...
    cfg = importlib.import_module('configs.train_finetune.naive.%s' % args.config).config
