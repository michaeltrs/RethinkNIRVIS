...
config.vis_backbone_checkpoint = "/home/michaila/Projects/facerec/heterogeneous/pretrain/mobilefacenet_checkpoints/mobilefacenet_MS1M_ReCA/23backbone.pth"
     # "/home/michaila/Projects/facerec/heterogeneous/pretrain/mobilefacenet_MS1M_ReCA_m06_ortho_SO01/23backbone.pth"
config.nirvis_classifier_checkpoint = None
config.update_batchnorm = True
config.margin = 0.6
config.output = '%s_init-MS1MReCA-SO01_RCT_%s_m06_lr1e4' % (config.architecture, config.nirvis_dataset)
