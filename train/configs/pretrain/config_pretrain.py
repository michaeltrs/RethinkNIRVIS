...
# Dataset - MS1M -------------------------------------------------------------------------------------------------------
config.root_dir = '/home/michaila/Data/MsCelebV1-Faces-Cropped'
config.paths_file = '/home/michaila/Data/MsCelebV1-Faces-Cropped/all_ms1m_paths.csv'
config.label2index_path = '/home/michaila/Data/MsCelebV1-Faces-Cropped/label2index.pickle'
...
config.lr = 0.1
config.batch_size = 64  # batch size per device
