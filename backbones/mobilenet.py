...
from backbones.mobilenet_utils import SEBlock, ECA_Layer, CbamBlock, Identity, GCT, Flatten
...
class MobileFaceNet(Module):
    def __init__(
        self, input_size=(112, 112), embedding_size=512, output_name="GDC", attention="none"
    ):
...
if __name__ == "__main__":
    ...
    net = MobileFaceNet(input_size=(112, 112), embedding_size=512, output_name="GDC", attention="none")

    for k in net.state_dict().keys():
        if net.state_dict()[k].grad is None:
            print(k)
