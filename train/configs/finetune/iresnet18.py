...
config.vis_backbone_checkpoint = "/home/michaila/Projects/facerec/heterogeneous/pretrain/iresnet18_MS1M_ReCA/23backbone.pth"
config.nirvis_classifier_checkpoint = None
config.update_batchnorm = True
config.margin = 0.8
config.output = '%s_init-MS1MReCA_RCT_%s_m08_lr1e4' % (config.architecture, config.nirvis_dataset)
